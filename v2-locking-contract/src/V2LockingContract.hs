...
tokenizedPid = PlutusV2.CurrencySymbol { PlutusV2.unCurrencySymbol = createBuiltinByteString [246, 26, 175, 238, 253, 60, 80, 238, 2, 237, 140, 2, 16, 38, 109, 164, 95, 229, 135, 205, 146, 24, 240, 159, 86, 26, 23, 44] }
