...
mkValidator datum redeemer context =
  case redeemer of
    Vote -> do 
      ...
      ; let b = traceIfFalse "Value Not Continuing"         $ isValueContinuing contOutputs validatingValue
      ; let c = traceIfFalse "Single Script Input Error"    $ isSingleScript txInputs
      ; let d = traceIfFalse "Incorrect Datum Update Error" $ isEmbeddedDatum contOutputs
