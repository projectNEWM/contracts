...
lockTkn = PlutusV2.TokenName {PlutusV2.unTokenName = createBuiltinByteString [78, 101, 119, 77, 95] }
...
getValidatorHash = PlutusV2.ValidatorHash $ createBuiltinByteString [204, 71, 121, 121, 45, 20, 44, 205, 208, 56, 26, 166, 248, 71, 198, 207, 177, 198, 203, 38, 228, 225, 80, 241, 226, 209, 50, 62]
