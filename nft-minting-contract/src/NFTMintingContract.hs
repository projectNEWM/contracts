...
getValidatorHash = PlutusV2.ValidatorHash $ createBuiltinByteString [214, 179, 126, 240, 90, 21, 147, 217, 118, 109, 168, 29, 154, 60, 47, 167, 142, 201, 39, 77, 89, 106, 207, 236, 111, 241, 134, 168]
