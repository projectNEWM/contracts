...
lockValidatorHash = PlutusV2.ValidatorHash $ createBuiltinByteString [7, 97, 104, 119, 123, 192, 31, 144, 70, 166, 103, 242, 217, 143, 77, 87, 49, 141, 67, 126, 181, 89, 197, 8, 60, 58, 162, 229]
-------------------------------------------------------------------------------
