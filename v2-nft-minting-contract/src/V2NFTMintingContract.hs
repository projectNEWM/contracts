...
lockValidatorHash = PlutusV2.ValidatorHash $ createBuiltinByteString [220, 49, 167, 250, 98, 219, 63, 112, 122, 29, 248, 178, 183, 229, 203, 21, 21, 54, 57, 174, 146, 59, 8, 150, 115, 231, 150, 229]
