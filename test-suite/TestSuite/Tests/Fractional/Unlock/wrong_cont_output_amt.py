#!/usr/bin/python
"""
Test fractionalization with the wrong amount of contining outputs.
"""
import os
import copy
...
def wrong_unlock_cont_output_amt():
    """
    Build a fractionalization transaction that attempts to send two continuning outputs to the script.
    """
    # env info
...
if __name__ == "__main__":
    ...
    output = wrong_unlock_cont_output_amt()
    print(output)
