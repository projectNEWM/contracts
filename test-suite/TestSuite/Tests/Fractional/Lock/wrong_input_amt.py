...
def wrong_lock_input_amt():
    """
    Build a fractionalization transaction that attempts to spend two inputs that have inline datums.
    """
    # env info
    ...
    tx_object = {
        ...
        "utxo_out":utxo_out,
        "signers": [attacker_pkh, newm_pkh, collat_pkh],
