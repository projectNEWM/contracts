#!/usr/bin/python
"""
Test tokenization with the wrong continuing datum.
"""
import os
import copy
...
def wrong_mint_cont_datum():
    """
    Build a tokenization transaction that has the incorrect continuing datum.
    """
    # env info
    ...
    next_script_datum['fields'][1]['int'] += 0
