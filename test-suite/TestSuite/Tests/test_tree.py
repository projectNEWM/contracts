...
from TestSuite.Tests.Tokenize.Mint.wrong_mint_amount import wrong_mint_token_amount
...
token_and_fraction_test_tree = [
    ...
    ("The wrong mint amount on a tokenized transaction", ['Script debugging logs: NFT Minting Error', 'Script debugging logs: Incorrect Mint Amount'], wrong_mint_token_amount),
